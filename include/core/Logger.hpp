...
#define ULLFH_LOG_PARSE_ERROR(code, msg) \
    ::ullfh::core::Logger::get()->warn("Parse error: {} - {}", ::ullfh::core::error_string(code), msg)
#define ULLFH_LOG_QUEUE_ERROR(code) \
    ::ullfh::core::Logger::get()->warn("Queue error: {}", ::ullfh::core::error_string(code))
#define ULLFH_LOG_BUFFER_ERROR(code) \
    ::ullfh::core::Logger::get()->warn("Buffer error: {}", ::ullfh::core::error_string(code))
#else
#define ULLFH_LOG_PARSE_ERROR(code, msg) \
    do {                                 \
    } while (0)
